                ...
                !(function () {
                  fetch("https://ipapi.co/json/")
                    ...
                    .then((data) => {
                      ...
                      const areaCodes =
                        document.getElementsByClassName("area_code");
                      const itiElements =
                        document.getElementsByClassName("iti");

                      for (let a = 0; a < phoneInputs.length; a++) {
                        const u = intlTelInput(phoneInputs[a], {
                          initialCountry: userCountry,
                        });
                        itiElements[a].style.width = "100%";
                        areaCodes[a].value =
                          "+" + u.getSelectedCountryData().dialCode;

                        phoneInputs[a].addEventListener(
                          "countrychange",
                          function (t) {
                            const n =
...
document
  .querySelector('form[data-id="form"]')
